...
ggplot(data,aes(x=date,y=r,label=label))+geom_line(color="#1c338e",size=1)+theme_bw()+labs(y="Reproductive number (R)",x="Date",title="Change of reproductive number due to B.1.1.7 spread")+coord_cartesian(ylim=c(0,NA),xlim=c(ymd("2020-01-01"),ymd("2020-04-01")))+ geom_hline(yintercept=1,linetype=2,color="#444444")+geom_label_repel(nudge_x =3,nudge_y =-0.2,color="#444444",size=4)
ggsave("change_in_r.png",width=6,height=4)
